...
| **Execution Date** | 2026-09-10 (Automated QA Runner) |
| **Overall Result** | PASS (21 of 21 Test Cases Verified — 100.0%) |
| **Excel Report File** | reports/2026-09-10/D1_Reports_2026-09-10.xlsx |
...
- **Actual Result:** On-chain deadline (1789050000) matched saved deadline (1789050000). Activated tournament and set deadlineConfirmedAt=2026-09-10T03:23:18.936190+00:00.
- **Status:** `PASS` (0.03 ms)
